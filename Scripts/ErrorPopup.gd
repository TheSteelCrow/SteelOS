...
func _ready():
	Main = get_parent()
	print(Main.WindowInstanceSelected)
...
func _process(delta):
	...
	if(MouseInZone && MouseButton1Down && Dragging == false && Main.WindowInstanceSelected == false):
		Dragging = true
